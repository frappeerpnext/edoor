  ...
  function getItemListFromGuestFolio(frm) {
    ...
    frappe.db
      ...
      .then((result) => {
        ...
        let html = frappe.render_template("desk_folio_transaction_list", {
    ...
    frappe
      ...
      .then((result) => {
        html = frappe.render_template("desk_folio_summary_list", {
          data: result.message,
        });
        $(frm.fields_dict["summary_list"].wrapper).html(html);
