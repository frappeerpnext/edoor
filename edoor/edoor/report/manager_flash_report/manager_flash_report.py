...
def get_report_data(filters):
	...
	report_data.append(occupy_data[0]["arrival_adult"] or 0)
	report_data.append(occupy_data[0]["arrival_child"] or 0)
	report_data.append(occupy_data[0]["in_house_adult"] or 0)
	report_data.append(occupy_data[0]["in_house_child"] or 0)
	report_data.append(occupy_data[0]["departure_adult"] or 0)
	report_data.append(occupy_data[0]["departure_child"] or 0)
	report_data.append(occupy_data[0]["walk_in_adult"] or 0)
	report_data.append(occupy_data[0]["walk_in_child"] or 0)
	report_data.append(occupy_data[0]["walk_in_room_night"] or 0)
	report_data.append(occupy_data[0]["arrival_room_night"] or 0)
	report_data.append(occupy_data[0]["departure_room_night"] or 0)
	report_data.append(occupy_data[0]["early_checked_out_adult"] or 0)
	report_data.append(occupy_data[0]["early_checked_out_child"] or 0)
	report_data.append(occupy_data[0]["early_checked_out"] or 0)
	report_data.append(occupy_data[0]["fit_room"] or 0)
	report_data.append(occupy_data[0]["git_room"] or 0)
	report_data.append(occupy_data[0]["fit_adult"] or 0)
	report_data.append(occupy_data[0]["fit_child"] or 0)
	report_data.append(occupy_data[0]["git_adult"] or 0)
	report_data.append(occupy_data[0]["git_child"] or 0)
	report_data.append(occupy_data[0]["complimentary_adult"] or 0)
	report_data.append(occupy_data[0]["complimentary_child"] or 0)
	report_data.append(occupy_data[0]["house_use_adult"] or 0)
	report_data.append(occupy_data[0]["house_use_child"] or 0)
	...
	report_data.append(forecasting[0]['tmr_room_occupy'] or 0)
	report_data.append(forecasting[0]['tmr_arrival_adult'] or 0)
	report_data.append(forecasting[0]['tmr_arrival_child'] or 0)
	report_data.append(forecasting[0]['tmr_departure_adult'] or 0)
	report_data.append(forecasting[0]['tmr_departure_child'] or 0)
	report_data.append(forecasting[0]['tmr_arrival'] or 0)
	report_data.append(forecasting[0]['tmr_departure'] or 0)

	stay_data= get_stay_data(filters)
	report_data.append(stay_data[0]['no_show_room'] or 0)
	report_data.append(stay_data[0]['no_show_adult'] or 0)
	report_data.append(stay_data[0]['no_show_child'] or 0)
	report_data.append(stay_data[0]['cancelled_room'] or 0)
	report_data.append(stay_data[0]['cancelled_adult'] or 0)
	report_data.append(stay_data[0]['cancelled_child'] or 0)


	#forecating for the next 7 days
	next_seven_day = get_forecasting_next_seven_day(filters)
	report_data.append(next_seven_day[0]['seven_day_room_occupy'] or 0)
	report_data.append(next_seven_day[0]['seven_day_arrival_adult'] or 0)
	report_data.append(next_seven_day[0]['seven_day_arrival_child'] or 0)
	report_data.append(next_seven_day[0]['seven_day_departure_adult'] or 0)
	report_data.append(next_seven_day[0]['seven_day_departure_child'] or 0)
	report_data.append(next_seven_day[0]['seven_day_arrival'] or 0)
	report_data.append(next_seven_day[0]['seven_day_departure'] or 0)
	...
	report_data.append(arrival_pax or 0)
	report_data.append(departure_pax or 0)
	report_data.append(vacant_rooms or 0)
	report_data.append(available_room or 0)
	report_data.append(room_minus_ooo_rooms or 0)
	report_data.append(room_minus_ooo_and_hous_use or 0)
	report_data.append(room_minus_ooo_and_complimentary or 0)
	report_data.append(room_minus_house_use_and_complimentary or 0)
	report_data.append(room_minus_complimentary or 0)
	report_data.append(room_minus_house_use or 0)
	report_data.append(total_arrival_pax or 0)
	report_data.append(total_inhoue_pax or 0)
	report_data.append(total_departure_pax or 0)
	report_data.append(walkin_inhouse_pax or 0)
	report_data.append(early_checkout_pax or 0)
	report_data.append(fit_pax or 0)
	report_data.append(git_pax or 0)
	report_data.append(cancalled_pax or 0)
	report_data.append(house_use_pax or 0)
	report_data.append(arrival_pax_for_seven_day or 0)
	report_data.append(departure_pax_for_seven_day or 0)
