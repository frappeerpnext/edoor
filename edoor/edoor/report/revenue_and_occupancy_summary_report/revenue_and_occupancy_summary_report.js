...
function setLinkField() {
  ...
  const business_source_filter =
    frappe.query_report.get_filter("business_source");
  ...
  frappe.call({
    ...
    callback: function (r) {
      ...
      const show_chart_series =
        frappe.query_report.get_filter("show_chart_series");
      show_chart_series.df.options = r.message.report_fields
