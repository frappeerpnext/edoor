...
def execute(filters=None):
	report_config = frappe.get_last_doc("Report Configuration", filters={"property":filters.property, "report":"Daily Reservation Report"} )
...
def get_report_data (filters, report_fields):
	...
	if filters.show_in_group_by:
		...
		for parent in parent_row:
			d = parent
			if filters.show_in_group_by=="arrival_date" and filters.show_in_group_by=="departure_date":
...
def get_filters(filters):
	...
	working_date between %(start_date)s and %(end_date)s """
