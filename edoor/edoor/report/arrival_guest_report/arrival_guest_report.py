...
def get_report_columns(filters,  report_fields):
	...
	if filters.show_in_group_by:
		report_fields = [d for d in report_fields if d.fieldname in filters.show_in_group_by]
...
def get_data (filters,report_fields):
	sql ="select {} as indent, 0 as is_group, ".format(1 if filters.group_by else 0)
