...
def get_report_data (filters, report_fields):
	...
	report_data = report_data + [d for d in data ]
	if filters.show_in_group_by:
...
def get_filters(filters):
	...
	if(require_drop_off,departure_date between %(start_date)s and %(end_date)s,arrival_date between %(start_date)s and %(end_date)s) and 
