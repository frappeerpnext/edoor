...
def get_report_columns(filters,report_config):
    ...
    columns = [
        {'key': "Business Source Type","fieldname":"row_group","label":"Business Source Type","width":150},
    ]
...
def get_occupy_data(filters,report_config):
    sql = "select business_source_type as row_group, "
    ...
    sql = "{} and ifnull(business_source_type,'') !='' ".format(sql)


    # group by
    
    sql = "{} group by business_source_type".format(sql)
