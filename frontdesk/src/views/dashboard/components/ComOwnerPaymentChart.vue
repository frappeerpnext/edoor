                            ...
                            <tr v-for="(payment, index) in data?.datasets" :key="index">
                                <td class="text-center">
                                    <div class="flex align-items-center ">
                                        <div class="h-1rem w-1rem border-circle inline-block me-2"
                                            :style="{ backgroundColor: payment.color }"></div> {{ payment.name }}
                                    </div>
                                </td>
                                <td class="text-right border-left-1">
                                    <CurrencyFormat :value="payment.values" />
                                </td>
                            </tr>
                            <tr>
