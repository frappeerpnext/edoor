<template>
    ...
    <div class="grid w-full">
        ...
        <div class="col-12 lg:col-3"  v-if="hasFilter('cashier_shift')">
        ...
        <div class="col-12 lg:col-3"  v-if="hasFilter('reservation')">
        ...
        <div class="col-12 lg:col-3"  v-if="hasFilter('reservation_stay')">
        ...
        <div class="col-12 lg:col-3" v-if="hasFilter('select_filter')">
        ...
        <div class="col-12 lg:col-3" v-if="hasFilter('reservation_type')">
        ...
        <div class="col-12 lg:col-3"  v-if="hasFilter('reservation_status')">
        ...
        <div class="col-12 lg:col-3"  v-if="hasFilter('room_type')">
        ...
        <div class="col-12 lg:col-3"  v-if="hasFilter('room_name_types')">
        ...
        <div class="col-12 lg:col-3"  v-if="hasFilter('rooms')">
        ...
        <div class="col-12 lg:col-3"  v-if="hasFilter('building')">
        ...
        <div class="col-12 lg:col-3"  v-if="hasFilter('floor')">
        ...
        <div class="col-12 lg:col-3"  v-if="hasFilter('housekeeper')">
        ...
        <div class="col-12 lg:col-3"  v-if="hasFilter('housekeeping_status')">
        ...
        <div class="col-12 lg:col-3"  v-if="hasFilter('account_name')">
        ...
        <div class="col-12 lg:col-3"  v-if="hasFilter('parent_account')">
        ...
        <div class="col-12 lg:col-3"  v-if="hasFilter('sale')">
        ...
        <div class="col-12 lg:col-3"  v-if="hasFilter('arrival_modes')">
        ...
        <div class="col-12 lg:col-3"  v-if="hasFilter('departure_mode')">
        ...
        <div class="col-12 lg:col-3"  v-if="hasFilter('business_source')">
        ...
        <div class="col-12 lg:col-3" v-if="hasFilter('rate_type')">
        ...
        <div class="col-12 lg:col-3" v-if="hasFilter('ledger_type')">
        ...
        <div class="col-12 lg:col-3" v-if="hasFilter('ledger_types')">
            <label> {{ $t('Ledger Type') }} </label><br>
        ...
        <div class="col-12 lg:col-3"  v-if="hasFilter('working_day')">
            <label> {{ $t('Working Day') }} </label><br>
            <ComAutoComplete v-model="filter.working_day" placeholder="working day" doctype="Working Day"
            class="auto__Com_Cus w-full" />
        </div>
        <div class="col-12 lg:col-3 mt-4"  v-if="hasFilter('group_by_ledger_type')">
            <div class="h-full" >
        ...
        <div class="col-12 lg:col-3" v-if="hasFilter('business_source_type')">
        ...
        <div class="col-12 lg:col-3 mt-4"  v-if="hasFilter('is_active_reservation')">
            <div class="h-full" >
                <div class="py-2 flex items-center w-full p-dropdown-label p-inputtext p-placeholder">
                <div>
        ...
        <div class="col-12 lg:col-3 mt-4"  v-if="hasFilter('show_cash_float')">
            <div class="h-full" >
                <div class="py-2 flex items-center w-full p-dropdown-label p-inputtext p-placeholder">
                <div>
        ...
        <div class="col-12 lg:col-3 mt-4"  v-if="hasFilter('show_cash_count')">
            <div class="h-full" >
                <div class="py-2 flex items-center w-full p-dropdown-label p-inputtext p-placeholder">
                <div>
        ...
        <div class="col-12 lg:col-3" v-if="hasFilter('select_user')">
        ...
        <div class="col-12 lg:col-3" v-if="hasFilter('audit_order')">
            <label> {{ $t('Order By') }} </label><br/>
