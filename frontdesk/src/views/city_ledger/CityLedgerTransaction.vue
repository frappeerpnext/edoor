<template>
   ...
   <ComDocumentList doctype="Folio Transaction" title="City Ledger Transaction" :options="options"
      list_view_setting="city_ledger_folio_transaction" @row-dblclick="onRowDblclick">
