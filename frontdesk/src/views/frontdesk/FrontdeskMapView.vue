  ...
  <ComFrontDeskLayout :title="$t('Map View')">
    ...
    <!-- Filter -->
     ...
     <ComSelect 
      ...
      />
     <ComSelect :clear="false" :options="timespanOption" v-model="filters.timespan" :placeholder="$t('Select Timespan')"/>
     <ComSelect   :filters="[['property', '=', property_name]]" :placeholder="$t('All Room Types')" v-model="filters.room_type" doctype="Room Type"   optionLabel="room_type" optionValue="name"></ComSelect>
     <div :class="bodyClass">
                <ComAutoComplete isFull :filters="[['property', '=', property_name]]" :placeholder="$t('All Business Source')" v-model="filters.business_source" doctype="Business Source" optionLabel="business_source" optionValue="name"/>
            </div>
    ...
    >
      ...
      >
        ...
        <text x="50%" y="50%" alignment-baseline="middle" text-anchor="middle" font-size="40" fill="#ffffff">
...
const timespanOption = ref(["Today","Yesterday","This Month","Next Month","Last Month","This Year","Last Year", "Date Range"])
...
function onLoadData(){
  getApi("frappe.desk.query_report.run",{
    ...
    filters: {"property":"ESTC  & HOTEL's","timespan":"Date Range","start_date":"2024-08-01","end_date":"2024-08-31","row_group":"Nationality","show_columns":[],"show_summary":1,"show_summary_field":[],"chart_type":"bar","show_chart_series":[]},
