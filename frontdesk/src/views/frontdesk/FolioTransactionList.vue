...
<script setup>
  ...
  const columns = ref([
    ...
    { fieldname: 'reservation_stay', label: 'Reservation Stay', header_class: "text-center", fieldtype: "Link", post_message_action: "view_reservation_stay_detail", default: true },
