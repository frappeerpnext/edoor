            ...
            <div class="col-12">
                <table>
                    ...
                    <ComStayInfoNoBox  label="Guest name"  >
                        ...
                        <span  @click="onViewGuestDetail(doc?.guest)" class="link_line_action">
{{  doc?.guest_name }}
                        </span>
                        </div>
                    </ComStayInfoNoBox>   
        ...
        <table>
            ...
            <ComStayInfoNoBox  label="Arrival">
                ...
                <span v-if="gv.dateFormat(oldEvent?.start) != gv.dateFormat(data?.start) " class="ms-2 px-2 rounded-lg me-2 text-white p-1px bg-green-500">
                New
                </span>
                </div>
            </ComStayInfoNoBox>
            ...
            <ComStayInfoNoBox titleClass="" label="Nights">
                ...
                <span v-if="moment(data?.end).diff(data?.start, 'days') != moment(oldEvent?.end).diff(oldEvent?.start, 'days') " class="ms-2 px-2 rounded-lg me-2 text-white p-1px bg-green-500"
                                >New
                                </span>
                </div>
            </ComStayInfoNoBox>   
...
<script setup>
import { ref, onMounted, inject, getDoc,postApi , computed} from "@/plugin"
