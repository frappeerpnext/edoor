<template>
  <ComDialogContent hideButtonClose titleButtonOK="Check Out Card Now" :hideIcon="false" @onOK="submit">
...
async function submit() {
  const isConfirm = await app.utils.onConfirm("Write Card", "Are you sure you want to check out this card?")
  if (!isConfirm) return ;
