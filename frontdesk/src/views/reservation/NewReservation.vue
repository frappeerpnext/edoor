    ...
    <ComDialogContent dialogClass="max-h-screen-newres overflow-auto" @onOK="onSave" :loading="isSaving"
        ...
        <div class="ms_message_cs_edoor">
            <Message v-if="hasFutureResertion">
                ...
                <Button class="border-none ml-auto mr-3" @click="onViewFutureReservation">{{ $t('View Reservation') }}
                </Button>
            </Message>
        </div>
                    ...
                    <div class="">
                        <div class="grid">
                            ...
                            <div class="col-12 md:col">
                                ...
                                <Calendar :disabled="doc.reservation.is_walk_in" :selectOtherMonths="true"
                                    class="p-inputtext-sm w-full" v-model="doc.reservation.reservation_date"
                        ...
                        <div class="grid m-0">
                            <div class="col-12 md:col px-0">
                                ...
                                <Calendar :disabled="doc.reservation.is_walk_in" :selectOtherMonths="true"
                                    class="p-inputtext-sm depart-arr w-full border-round-xl"
                            ...
                            <div class="night__wfit col-fixed px-0" style="width: 150px;">
                                <label class="hiddent">{{ $t('Nights') }}<span
                            ...
                            <div class="col px-0">
                                ...
                                <Calendar :selectOtherMonths="true" class="p-inputtext-sm depart-arr w-full"
                                    ...
                                    showIcon showButtonBar panelClass="no-btn-clear" />
                            </div>
                        </div>
                    </div>
                    <div class="">
                        ...
                        <div class="w-full n__re-custom">
                            ...
                            <div class="grid">
                                ...
                                <div class="col-12 lg:col-6 xl:col-4 pt-2">
                                    ...
                                    <Dropdown v-model="doc.guest_info.gender" optionLabel="label" optionValue="value"
                                        :options="gender_list" placeholder="Gender" class="w-full" />
                                </div>
                                <div class="col-12 lg:col-6 xl:col-4 pt-2">
                        ...
                        <tr v-for="(d, index) in doc.reservation_stay" :key="index">
                            <td class="pr-2 min-w-5rem">
                                ...
                                <Dropdown v-model="d.room_type_id" :options="room_types" optionValue="name"
                                    @change="onSelectRoomType(d)" optionLabel="room_type"
                                    :placeholder="$t('Select Room Type')" class="w-full">
                                    <template #option="slotProps">
                                        <div class="flex align-items-center">

                                            <div>{{ slotProps.option.room_type_alias }} - {{ slotProps.option.room_type
                                                }} ({{ slotProps.option.total_vacant_room ||
                                                    0 }})</div>
                                        </div>
                                    </template>
                                </Dropdown>
                            ...
                            <td class="p-2 min-w-5rem">
                                <div class="flex gap-2">
                                    ...
                                    <div v-if="d.room_id" class="flex gap-2 space-around">
                                        <template v-for="(am, icon_index) in room_amenities(d.room_id)?.amenities"
                                            :key="icon_index">
                            ...
                            <td v-if="doc.reservation_stay.length > 1" class="pl-2 text-end w-3rem">
                                <Button :loading="d.loading" class="tr-h__custom text-3xl h-12" icon="pi pi-trash"
                                    @click="onDeleteStay(index)" aria-label="Filter" />
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div class="flex justify-between gap-2">
                <div>
                    <Button @click="onAddRoom" class="px-4 mt-2 conten-btn">
                        <img :src="theme == 'estc' ? IconAddRoom : iconPlusSignWhite"
                            class="btn-add_comNote__icon me-1" />
                        {{ $t('Add More Room') }}
                    </Button>
                </div>
                <div class="flex gap-2">
                    ...
                    <Button class="px-4 mt-2 conten-btn " :label="$t('View Room Availability')"
                        @click="onViewRoomAvailable" />
                </div>
            </div>
