   ...
   <ComOverlayPanelContent style="width: 40rem;" :loading="loading" @onSave="onSave" @onCancel="onClose">
    ...
    <div class="grid py-2 wp-number-cus">
            <div class="col-6">
                ...
                <Calendar panelClass="no-btn-clear" :selectOtherMonths="true" showIcon v-model="data.arrival_date" showButtonBar  :min-date="new Date(moment(data.min_date))" @update:modelValue="onStartDate" dateFormat="dd-mm-yy" class="w-full"/>
            </div>
            <div class="col-6">
