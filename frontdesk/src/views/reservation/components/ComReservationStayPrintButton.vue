...
items.value.push({
    ...
    command: () => {
        ...
        if (window.setting.server_report_url) {
            OpenServerReport("/Front Desk/rptGuestRegistrationCard", "Guest Registration Card")
...
items.value.push({
    ...
    command: () => {
        if (window.setting.server_report_url) {
            OpenServerReport("/Front Desk/rptReservationStayConfirmationVoucher", "Confirmation Voucher")
...
OpenServerReport("/Front Desk/rptReservationStayFolioDetailByReservatinStay", "Folio Detail by Reservation")
...
OpenServerReport("/Front Desk/rptFolioListByReservationStay", "Folio List by Reservation Stay")
...
OpenServerReport("/Front Desk/rptReservationStayDetail", "Reservation Stay Detail")
...
function OpenServerReport(report_path, title, parameters = undefined) {
    ...
    if (!parameters) {
        params = [
            ...
            { name: 'reservation_stay', values: [props.reservation_stay] },
