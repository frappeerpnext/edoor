...
<ComDialogNote :header="`Delete Folio - ${rs.selectedFolio.name}`" :visible="openNote" :loading="loading" @onOk="deleteFilio" @onClose="onCloseNote"/>
</template>
<script setup>
    ...
    accept: () => {
        db.updateDoc('Reservation Folio', rs.selectedFolio.name, {
            ...
            .then((doc) => {
                ...
                toast.add({ severity: 'success', summary: 'Mark Folio as Master Folio', 
