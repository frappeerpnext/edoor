        ...
        <div v-if="doc"> 
            ...
            <table class="mb-4">
                <tr>
                    ...
                    Reservation 
                    <span class="ms-2 px-2 rounded-lg me-2 text-white p-1px" :style="{ backgroundColor: doc.reservation_status_color }" >{{ doc.reservation_status }}</span>
                </th>
                </tr>
                ...
                <ComStayInfoNoBox  label="Reservation Stay"> 
                    <span @click="onViewReservationStayDetail(doc.reservation_stay)" class="-ml-2 text-right link_line_action1">
            ...
            <div class="line-height-1 -mt-2 text-right flex p-0 flex-col justify-center gap-2 w-full text-sm white-space-nowrap overflow-hidden text-overflow-ellipsis">
                <div>
            ...
            <hr class="mt-3 mb-2">
                    ...
                    Folio Detail - {{ doc.name }} <span class="ms-2 px-2 rounded-lg  text-white p-1px" :class="doc.status == 'Open' ? 'bg-green-500' : 'surface-500'">{{ doc.status }}</span>
