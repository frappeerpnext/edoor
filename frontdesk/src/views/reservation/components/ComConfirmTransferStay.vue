<template>
    <ComDialogContent @onOK="onOk" hideButtonClose titleButtonOK="Ok" :hideIcon="false" :loading="loading">
        ...
        <div>
            ...
            <label for="target_reservation" class="mb-1 font-medium block"> {{ $t('Target Reservation') }} </label>
        ...
        <Textarea autofocus v-model="data.note" id="reason-text" rows="3" cols="50" :placeholder=" $t('Please Enter Reason') " class="w-full" />
