                    ...
                    <div class="col-12">
                        <div class="flex items-center gap-2 ">
                            <Checkbox inputId="isarrivalmode" v-model="stay.require_pickup" :binary="true" :trueValue="1"
                                :falseValue="0" />
                            <label for="isarrivalmode" class="text-lg font-semibold cursor-pointer">{{ $t('Request Pickup')}}</label>
                        </div>
                    </div>
                    <div class="flex flex-wrap " v-bind:class="{ 'pointer-events-none opacity-60': !stay.require_pickup }">
                        <div class="col-12">
                            <label for="num">{{ $t('Pickup Mode')}} </label>
                        ...
                        <div class="col-6">
                            <label for="arrival_driver">{{ $t('Pickup Driver')}}</label>
                        ...
                        <div class="col-12">
                            <label for="arrival_none">{{ $t('Note')}}</label>
                ...
                <div class="flex flex-wrap">
                    <div class="col-12">
                        <div class="flex items-center gap-2">
                            ...
                            <label for="isdeparturemode" class="text-lg font-semibold cursor-pointer">
                                {{ $t('Request Drop Off')}}
                                </label>
                        </div>
                    </div>
                    <div class="flex flex-wrap "
                        ...
                        <div class="col-12">
                            <label for="num">{{ $t('Drop Off Mode')}}</label>
