  ...
  <ComDialogContent @onOK="onSave" :loading="loading" @onClose="onClose">
    <div class="grid">
        ...
        <div class="w-6">
         <label for="Note Date">Note Date</label>
          <div class="card flex justify-content-left">
            <Calendar :selectOtherMonths="true" class="w-full p-inputtext-sm depart-arr border-round-xl" v-model="data.note_date"
      ...
      <div class="col-6"> 
        ...
        <ComAutoComplete isFull v-model="data.room_id" placeholder="Room" doctype="Room" />
      </div>
      <div class="col-6"> 
        <label for="Reservation">Guest name</label>
        <ComAutoComplete isFull v-model="data.guest" placeholder="Guest Name" doctype="Customer" />
      </div>
      <div class="col-6"> 
...
function onSave(){
  ...
  createUpdateDoc("Frontdesk Note", {data: dataSave})
  .then((r)=>{
    loading.value = false
