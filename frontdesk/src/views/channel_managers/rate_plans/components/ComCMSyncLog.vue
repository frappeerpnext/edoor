<template>
  <ComDocumentList
    ...
    list_view_setting="rate_plan_channel_manager_sych_log_list"
    :options="options"
...
const options = {
  ...
  filterOptions: [
    ...
    filters: [['property', '=', window.property_name],["rate_type","=",route.params.name],["request_type","in",["Prices update","Restriction update"]]],
};
